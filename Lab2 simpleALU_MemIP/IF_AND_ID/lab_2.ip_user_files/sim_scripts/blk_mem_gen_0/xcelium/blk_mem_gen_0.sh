...
#
# Script generated by Vivado on Mon Jul 17 22:31:24 +0800 2023
...
#
# Usage        : blk_mem_gen_0.sh
#                blk_mem_gen_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_gen_0.sh [-reset_run]
#                blk_mem_gen_0.sh [-reset_log]
#                blk_mem_gen_0.sh [-help]
#
...
#                script (type 'blk_mem_gen_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_6 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_6 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_gen_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.blk_mem_gen_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.blk_mem_gen_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log blk_mem_gen_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: blk_mem_gen_0.sh [-step]\n\
Usage: blk_mem_gen_0.sh [-lib_map_path]\n\
Usage: blk_mem_gen_0.sh [-reset_run]\n\
Usage: blk_mem_gen_0.sh [-reset_log]\n\
Usage: blk_mem_gen_0.sh [-keep_index]\n\
