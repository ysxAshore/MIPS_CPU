...
design_libs=(xpm blk_mem_gen_v8_4_6 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_gen_0_simv.daidir vcs_lib c.obj)
